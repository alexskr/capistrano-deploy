...
//    const runner2 = new toolrunner.ToolRunner('ssh-agent', ['-a', authSock]);
    const runner2 = new toolrunner.ToolRunner('ssh-agent');
    yield runner2.exec();
...
function deploy(target, capistranoCommands, options) {
  return __awaiter(this, void 0, void 0, function* () {
    let args = [];
    if (!target) {
...
function run() {
  return __awaiter(this, void 0, void 0, function* () {
    const capistranoCommands = JSON.parse(core.getInput('capistrano_commands'));
    ...
    yield deploy(target, capistranoCommands, options);
  });
}
